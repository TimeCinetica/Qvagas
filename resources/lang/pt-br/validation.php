...
return [
    ...
    */
    ...
    'iso_date'             => ':attribute não é uma data no formato ISO 8601.',
    ...
    'unique_except_self'   => ':attribute já está em uso.',
    ...
    */
    ...
    'custom' => [
        'locations' => [
            'required_if' => 'O trajeto deve ser informado caso a contratação não seja por hora.',
        ]
    ],
    ...
    */
    'attributes' => [
        ...
        'accountOwnerCpf'    => 'CPF do titular da conta',
        'locations'          => 'trajeto',
        'categoryId'         => 'categoria do veículo',
        'requesterId'        => 'requisitante',
        'currentPassword'    => 'senha atual',
        'scheduleDate'       => 'data do agendamento',
        'contractedHours'    => 'quantidade de horas contratadas',
        'startFare'          => 'bandeirada',
        'farePerRoute'       => 'sub-bandeirada',
    ],
